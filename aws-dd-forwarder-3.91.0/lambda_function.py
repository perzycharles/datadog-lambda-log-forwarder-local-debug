...
def datadog_forwarder(event, context):
    ...
    print("***************************************************************************************")
    print("**** This log is from the lambda function entry point: lambda_function.py line 476 ****")
    print("context.log_group_name:", context.log_group_name)
    events = parse(event, context)
    metrics, logs, traces = split(events)
    print("**** This log is from the lambda function entry point: lambda_function.py line 481 ****")
